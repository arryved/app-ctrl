module github.com/arryved/app-ctrl/worker
...
require (
	...
	github.com/arryved/app-ctrl/api v0.0.0-20240823221652-f845aca3b559
	github.com/arryved/app-ctrl/daemon v0.0.0-20240703081846-f2d17f8ca377
